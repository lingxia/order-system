  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("id,cate_id,name,price,discountPrice,discountDesc,discountCount,use_property,unit,goods_type,sort,content,images,remain_count,month_sell_count,is_sell,is_alone_sale,property").get().then((res) => {
